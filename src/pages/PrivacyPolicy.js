    ...
    return (
        <div>
            ...
            <main className="legalNotice">
                ...
                <div className="privacyPolicy__partage">
                    <h2>Cookies</h2>
                    <p>Vous pouvez désactiver les cookies de Google Analytics en utilisant les paramètres de votre navigateur, mais veuillez noter que cela peut affecter votre expérience de navigation sur notre site portfolio. Vous pouvez également vous opposer à l'utilisation de vos données par Google Analytics en installant le module complémentaire de navigateur pour la désactivation de Google Analytics.</p>
                </div>
                <div className="privacyPolicy__partage">
