...
const Carouselbis = ({title, data, id}) => {
    ...
    const CustomArrow = ({classArrow, onClick, arrow}) => <img className={classArrow} src={arrow} alt="arrow" onClick={onClick} />
                ...
                <Slider
                    ...
                    {data &&
                        data.map((picture, index) => (
                            <div key={index}>
                                <img className="carousel__slide carouselbis__img" src={picture.screen} alt={picture.description} />
                            </div>
                        ))}
                </Slider>
            </section>
